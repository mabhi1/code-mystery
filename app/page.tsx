...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center gap-8 min-h-[60vh]">
      <div className="p-8 border border-green-900/50 rounded-lg bg-black/50 backdrop-blur-sm shadow-2xl max-w-2xl w-full">
        ...
        <div className="space-y-6 text-center">
            ...
            <div className="text-sm font-mono text-green-500/80 border-t border-green-900/30 pt-4 mt-6">
