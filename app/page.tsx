  ...
  return (
    <div className="flex flex-col items-center justify-center gap-5">
      ...
      <div className="text-lg">
        ...
        might need the basics of web development techniques to go throught the challenges. Don't hesitate to search the
        web if you are stuck anywhere. All the best 🙂.
      </div>
